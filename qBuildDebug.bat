...
cmake -j4 -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=Debug -DGUTILS_TOOLS=0 -DGUTILS_TEST=0 -DZLIB_INCLUDE_DIR="%zlibIF%" -DZLIB_LIBRARY="%zlibLL%" -DICONV_INCLUDE_DIR="%iconvIF%" -DICONV_LIBRARIES="%iconvLL%" ../../genieutils/
mingw32-make
CD ../../genieutils/
PAUSE
